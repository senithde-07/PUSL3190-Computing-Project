...
$sql_category_1 = "SELECT COUNT(*) AS count_category_1 FROM locations WHERE catgeory  = 1";
...
$sql_category_2 = "SELECT COUNT(*) AS count_category_2 FROM locations WHERE catgeory  = 2";
